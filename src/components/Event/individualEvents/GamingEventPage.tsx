      		...
      		<div className='gaming-content'>
        		...
        		<div className='gamingMainContent'>
					...
					{listData.acceptance?.map((acceptanceItem: any, index: number) => {
						return(
							<p key={index} className='rules'>{acceptanceItem}</p>
						);
					})}
					...
					{listData.generalRules?.map((genRulesItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{genRulesItems}</p>
						);
					})}
					...
					{listData.structure?.map((structItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{structItems}</p>
						);
					})}
					...
					{listData.gameModes?.map((gameItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{gameItems}</p>
						);
					})}

                    {listData.maps && (
                        <h3 className='gamingSubtitle'>Maps :</h3>
                    )}
					{listData.maps?.map((mapItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{mapItems}</p>
						);
					})}
					...
					{listData.bannedUtils?.map((bannedItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{bannedItems}</p>
						);
					})}
					...
					{listData.operatorSkills?.map((opItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{opItems}</p>
						);
					})}
					...
					{listData.lethalUtil?.map((lethalItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{lethalItems}</p>
						);
					})}
					...
					{listData.tacticalUtil?.map((tactItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{tactItems}</p>
						);
					})}

                    {listData.perks && (
                        <h3 className='gamingSubtitle'>Perks :</h3>
                    )}
					{listData.perks?.map((perksItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{perksItems}</p>
						);
					})}
					...
					{listData.weaponPerks?.map((weaponperksItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{weaponperksItems}</p>
						);
					})}
					...
					{listData.scoreStreaks?.map((scorestreaksItems: any, index: number) => {
						return(
							<p key={index} className='rules'>{scorestreaksItems}</p>
						);
					})}

					<div className='gaming-note'> {/* <h3>Note : </h3> {listData.note} */}</div>
