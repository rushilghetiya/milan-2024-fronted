...
function Home() {
  ...
  return (
    <div>
      <section className="h-screen w-screen homeHero ">
        {transitions((style, i) => {
          return (
            <animated.div
              className="bg"
        ...
        <section className="  relative  ">
          <div className="py-[10rem] w-full dark:bg-black bg-[#070717]  dark:bg-dot-[black] bg-dot-white relative flex items-center justify-center ">
            ...
            <div>
              ...
              <p className="font-['montserrat'] text-white text-[1.1rem]  font-medium tracking-wider  text-justify pt-[30px] w-[60%] m-auto leading-[125%] aboutMilan p-4">
                <b>
